...
const Suggestions: React.FC<Props> = ({ close, add }) => {
  ...
  const [suggestions] = useState([
    { id: '1', name: 'Not being listened to' },
    { id: '2', name: 'Feeling pressured' },
    { id: '3', name: 'Being touched' },
    { id: '4', name: 'Lack of privacy' },
    { id: '5', name: 'Arguments' },
    { id: '6', name: 'Not having control' },
    { id: '7', name: 'Not feeling safe' },
    { id: '8', name: 'Particular people' },
    { id: '9', name: 'Particular time of day/year' },
    { id: '10', name: 'Darkness' },
    { id: '11', name: 'Being isolated' },
    { id: '12', name: 'Missing family/friends' },
    { id: '13', name: 'Distressing thoughts/nightmares' },
    { id: '14', name: 'Memories' },
    { id: '15', name: 'Cravings' }
  ]);
