...
const Suggestions: React.FC<Props> = ({ close, add }) => {
  ...
  const [suggestions] = useState<Suggestion[]>([
    { id: '1', name: 'Do some exercise' },
    { id: '2', name: 'Take my medications' },
    { id: '3', name: 'Get enough sleep' },
    { id: '4', name: 'Eat well' },
    { id: '5', name: 'Practice relaxation techniques' },
    { id: '6', name: 'Look after animals, pets' },
    { id: '7', name: 'Do some gardening' },
    { id: '8', name: 'Read' },
    { id: '9', name: 'Join a group activity' },
    { id: '10', name: 'Be creative (e.g. draw, paint, write)' },
    { id: '11', name: 'Have goals and plans' },
    { id: '12', name: 'Think diffirently' },
    { id: '13', name: 'Avoid alcohol and/or drugs' },
    { id: '14', name: 'Attend appointments with my doctor' },
    { id: '15', name: 'Attend appointments with another service/ worker' }
  ]);
