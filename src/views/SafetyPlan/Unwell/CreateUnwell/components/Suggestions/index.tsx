...
const Suggestions: React.FC<Props> = ({ close, add }) => {
  ...
  const [suggestions] = useState<Suggestion[]>([
    { id: '1', name: 'Give my medication to someone else to look after' },
    {
      id: '2',
      name:
        'Remove or lock up items that could be used to harm myself or others'
    },
    { id: '3', name: 'My pets be fed and taken care of' },
    { id: '4', name: 'My children be taken care of' },
    { id: '5', name: 'My rent be paid' },
    { id: '6', name: 'Work be contacted' }
  ]);
