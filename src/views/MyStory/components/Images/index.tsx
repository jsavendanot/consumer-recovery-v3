    ...
    <>
      ...
      <Hidden smDown>
        <Grid container>
          <Hidden mdDown>
            <Grid item lg={2}></Grid>
            <Grid item xs={12} sm={8} md={7} lg={8} style={{ marginTop: '40px' }}>
              <Typography className={classes.story_title} variant="h1">My story</Typography>
            </Grid>
            <Grid item lg={2}></Grid>
          </Hidden>
          <Grid item md={2} lg={2}></Grid>
          {images.length > 0 ? (
            <Grid item xs={12} sm={8} md={8} lg={8} className={classes.flexItem}>
              <IconButton
                style={{ padding: '0', marginRight: '20px' }}
                onClick={back}>
                <ArrowBackIos
