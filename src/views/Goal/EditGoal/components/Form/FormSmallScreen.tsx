    ...
    <>
      <div className={classes.header}>
        <div style={{ display: 'flex', alignItems: 'center', flexGrow: 1 }}>
          ...
          <span className={classes.headerText}>Update Goal</span>
        </div>
        <Check className={classes.headerIcon} />
      </div>
      <div className={classes.container}>
        ...
        <TextField
          error={hasError('desc')}
          variant="outlined"
          placeholder="I want to be healthy so that I can enjoy life more."
          name="desc"
          value={goal.desc}
          multiline
          className={classes.textField}
        ...
        <GoalImage
          focusArea={focusAreas.find(area => area.id === goal.focusAreaId)!}
        />
